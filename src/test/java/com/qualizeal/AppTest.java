...
public class AppTest {
	...
	static int counter1ForTest4, counter1ForTest5, counter1ForTest6, counter1ForTest7,
			   counter2ForTest4, counter2ForTest5, counter2ForTest6, counter2ForTest7, 
			   counter3ForTest4, counter3ForTest5, counter3ForTest6, counter3ForTest7;
	...
	public void test1() {
		...
		try {
			operationClass = Class.forName("com.qualizeal.javaapp07.operation.PalindromeNumber");
	...
	public void test2() {
		...
		try {
			operationMethod = operationClass.getMethod("definePalindromeNumber");
			
			String expectedMethodSyntax = "public java.lang.String com.qualizeal.javaapp07.operation.PalindromeNumber.definePalindromeNumber()";
	...
	public void test3() {
		...
		try {
			operationMethod = operationClass.getMethod("verifyIfNumberIsPalindromeOrNot", Integer.TYPE);
			
			String expectedMethodSyntax = "public java.lang.String com.qualizeal.javaapp07.operation.PalindromeNumber.verifyIfNumberIsPalindromeOrNot(int)";
			String actualMethodSyntax = operationMethod.toString();
	...
	public void test4(int num) {
		int[] sampleInputs = {1, 2, 3, 4, 5, 6, 7};
		int[] parameters1 = {44, 45, 454, 455, 4554, 4555, 10};
		String[] expectedResults = {"Palindrome Number", "Not a Palindrome Number","Palindrome Number", "Not a Palindrome Number","Palindrome Number", "Not a Palindrome Number", "Not a Palindrome Number"};
